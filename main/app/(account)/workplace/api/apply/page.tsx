...
export default function ApplyPage() {
  ...
  const handleStatusChange = (key: ApiKey) => {
    toast.info("This feature is under development", {
      description:
        "The ability to enable/disable API keys will be available soon.",
    });
  };
          ...
          <Card className="p-4 sm:p-6 bg-card">
            <div className="flex justify-between items-center mb-6">
              <Button
                ...
                onClick={() => {
                  window.open(
                    "https://wcn3glqwz3m6.feishu.cn/share/base/form/shrcnMOPUTn1f97EpPSinEIex7d",
                    "_blank",
                    "noopener,noreferrer"
                  );
                }}
            ...
            <div className="space-y-4">
              ...
              <div className="hidden sm:block">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className="dark:text-muted-foreground w-[40%]">
                        API Key
                      </TableHead>
                      ...
                      <TableRow>
                        <TableCell colSpan={4} className="text-center py-8">
                          ...
                          <p className="text-sm text-muted-foreground mt-1">
                            Click the button above to create your first API key.
                          </p>
                        </TableCell>
                      </TableRow>
                    ) : (
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">
                      Remember to keep your API key secure and never share it
                      publicly.
                    </p>
                  </div>
                </div>
